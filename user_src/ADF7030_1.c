...
void TestCarrier(u8 KeyVel)
{
    ...
    switch(KeyVel)
    {
      ...
      case KEY_SW2_Down:{
        switch(mode)
        {
          case 0:RADIO_DIG_TX_CFG0_32bit_20000304 &= 0xFFFFFFFD;mode = 1;TextPlay = ' ';break;   //FSK
          case 1:RADIO_DIG_TX_CFG0_32bit_20000304 |= 2;mode = 0;TextPlay = 'G';break; //GFSK
          default:break;
        }
